...
// Kanto (FRLG) flag definitions — copied from HnS pokemonHnS source.
// Included in FRLG assembler contexts (map_events.s, event_scripts.s).
// Flags that overlap with Emerald flags.h silently re-define with the same value.
...
// ---------------------------------------------------------------------------
// Aliases required by Ultimate-Awakening Kanto C code
// ---------------------------------------------------------------------------

// Kanto gym badge flags (C code uses FLAG_KANTO_BADGE*_GET prefix)
#define FLAG_KANTO_BADGE01_GET  FLAG_BADGE01_GET  // Boulder Badge (Brock)
#define FLAG_KANTO_BADGE02_GET  FLAG_BADGE02_GET  // Cascade Badge (Misty)
#define FLAG_KANTO_BADGE03_GET  FLAG_BADGE03_GET  // Thunder Badge (Lt. Surge)
#define FLAG_KANTO_BADGE04_GET  FLAG_BADGE04_GET  // Rainbow Badge (Erika)
#define FLAG_KANTO_BADGE05_GET  FLAG_BADGE05_GET  // Soul Badge (Koga)
#define FLAG_KANTO_BADGE06_GET  FLAG_BADGE06_GET  // Marsh Badge (Sabrina)
#define FLAG_KANTO_BADGE07_GET  FLAG_BADGE07_GET  // Volcano Badge (Blaine)
#define FLAG_KANTO_BADGE08_GET  FLAG_BADGE08_GET  // Earth Badge (Blue/Giovanni)

// World map visited flags for Kanto cities (debug.c uses FLAG_WORLD_MAP_* names)
#define FLAG_WORLD_MAP_PALLET_TOWN              FLAG_VISITED_PALLET_TOWN
#define FLAG_WORLD_MAP_VIRIDIAN_CITY            FLAG_VISITED_VIRIDIAN_CITY
#define FLAG_WORLD_MAP_PEWTER_CITY              FLAG_VISITED_PEWTER_CITY
#define FLAG_WORLD_MAP_CERULEAN_CITY            FLAG_VISITED_CERULEAN_CITY
#define FLAG_WORLD_MAP_LAVENDER_TOWN            FLAG_VISITED_LAVENDER_TOWN
#define FLAG_WORLD_MAP_VERMILION_CITY           FLAG_VISITED_VERMILION_CITY
#define FLAG_WORLD_MAP_CELADON_CITY             FLAG_VISITED_CELADON_CITY
#define FLAG_WORLD_MAP_FUCHSIA_CITY             FLAG_VISITED_FUCHSIA_CITY
#define FLAG_WORLD_MAP_CINNABAR_ISLAND          FLAG_VISITED_CINNABAR_ISLAND
#define FLAG_WORLD_MAP_INDIGO_PLATEAU_EXTERIOR  FLAG_VISITED_INDIGO_PLATEAU
#define FLAG_WORLD_MAP_SAFFRON_CITY             FLAG_VISITED_SAFFRON_CITY

// Sevii Island world map flags (debug menu only; Sevii Islands not yet implemented).
// Placed above SPECIAL_FLAGS_END (0x407F) to avoid collisions.
#define FLAG_KANTO_SEVII_VISITED_START          0x4080
#define FLAG_WORLD_MAP_ONE_ISLAND               (FLAG_KANTO_SEVII_VISITED_START + 0x0)
#define FLAG_WORLD_MAP_TWO_ISLAND               (FLAG_KANTO_SEVII_VISITED_START + 0x1)
#define FLAG_WORLD_MAP_THREE_ISLAND             (FLAG_KANTO_SEVII_VISITED_START + 0x2)
#define FLAG_WORLD_MAP_FOUR_ISLAND              (FLAG_KANTO_SEVII_VISITED_START + 0x3)
#define FLAG_WORLD_MAP_FIVE_ISLAND              (FLAG_KANTO_SEVII_VISITED_START + 0x4)
#define FLAG_WORLD_MAP_SIX_ISLAND               (FLAG_KANTO_SEVII_VISITED_START + 0x5)
#define FLAG_WORLD_MAP_SEVEN_ISLAND             (FLAG_KANTO_SEVII_VISITED_START + 0x6)
#define FLAG_WORLD_MAP_ROUTE4_POKEMON_CENTER_1F  (FLAG_KANTO_SEVII_VISITED_START + 0x7)
#define FLAG_WORLD_MAP_ROUTE10_POKEMON_CENTER_1F (FLAG_KANTO_SEVII_VISITED_START + 0x8)
#define FLAG_WORLD_MAP_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL (FLAG_KANTO_SEVII_VISITED_START + 0x9)
#define FLAG_WORLD_MAP_UNDERGROUND_PATH_EAST_WEST_TUNNEL   (FLAG_KANTO_SEVII_VISITED_START + 0xA)
#define FLAG_WORLD_MAP_POKEMON_LEAGUE_LORELEIS_ROOM        (FLAG_KANTO_SEVII_VISITED_START + 0xB)


// ---------------------------------------------------------------------------
// Kanto/FRLG hidden item flags
// Placed at 0x500 (first gap after last story flag at 0x4FF).
// Must be >= FLAG_HIDDEN_ITEMS_START (0x1F4) to pass bg_hidden_item_event check.
// ---------------------------------------------------------------------------
#define FLAG_KANTO_HIDDEN_ITEMS_START                               0x500
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_BIG_PEARL  (FLAG_KANTO_HIDDEN_ITEMS_START + 0x00)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_BLUK_BERRY (FLAG_KANTO_HIDDEN_ITEMS_START + 0x01)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_RAZZ_BERRY (FLAG_KANTO_HIDDEN_ITEMS_START + 0x02)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_SITRUS_BERRY (FLAG_KANTO_HIDDEN_ITEMS_START + 0x03)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_NEST_BALL  (FLAG_KANTO_HIDDEN_ITEMS_START + 0x04)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_STARDUST   (FLAG_KANTO_HIDDEN_ITEMS_START + 0x05)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_STARDUST_2 (FLAG_KANTO_HIDDEN_ITEMS_START + 0x06)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_STAR_PIECE (FLAG_KANTO_HIDDEN_ITEMS_START + 0x07)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_ROCKET_WAREHOUSE_NEST_BALL (FLAG_KANTO_HIDDEN_ITEMS_START + 0x08)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_ROCKET_WAREHOUSE_NET_BALL  (FLAG_KANTO_HIDDEN_ITEMS_START + 0x09)
#define FLAG_HIDDEN_ITEM_FOUR_ISLAND_PEARL                      (FLAG_KANTO_HIDDEN_ITEMS_START + 0x0A)
#define FLAG_HIDDEN_ITEM_FOUR_ISLAND_ULTRA_BALL                 (FLAG_KANTO_HIDDEN_ITEMS_START + 0x0B)
#define FLAG_HIDDEN_ITEM_MT_EMBER_EXTERIOR_FIRE_STONE           (FLAG_KANTO_HIDDEN_ITEMS_START + 0x0C)
#define FLAG_HIDDEN_ITEM_MT_EMBER_EXTERIOR_ULTRA_BALL           (FLAG_KANTO_HIDDEN_ITEMS_START + 0x0D)
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_BIG_MUSHROOM               (FLAG_KANTO_HIDDEN_ITEMS_START + 0x0E)
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_BIG_MUSHROOM_2             (FLAG_KANTO_HIDDEN_ITEMS_START + 0x0F)
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_BIG_MUSHROOM_3             (FLAG_KANTO_HIDDEN_ITEMS_START + 0x10)
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_TINY_MUSHROOM              (FLAG_KANTO_HIDDEN_ITEMS_START + 0x11)
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_TINY_MUSHROOM_2            (FLAG_KANTO_HIDDEN_ITEMS_START + 0x12)
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_TINY_MUSHROOM_3            (FLAG_KANTO_HIDDEN_ITEMS_START + 0x13)
#define FLAG_HIDDEN_ITEM_MT_MOON_B2F_ETHER                      (FLAG_KANTO_HIDDEN_ITEMS_START + 0x14)
#define FLAG_HIDDEN_ITEM_MT_MOON_B2F_MOON_STONE                 (FLAG_KANTO_HIDDEN_ITEMS_START + 0x15)
#define FLAG_HIDDEN_ITEM_NAVEL_ROCK_SUMMIT_SACRED_ASH           (FLAG_KANTO_HIDDEN_ITEMS_START + 0x16)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_BIG_PEARL    (FLAG_KANTO_HIDDEN_ITEMS_START + 0x17)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_PEARL        (FLAG_KANTO_HIDDEN_ITEMS_START + 0x18)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_PEARL_2      (FLAG_KANTO_HIDDEN_ITEMS_START + 0x19)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_STARDUST     (FLAG_KANTO_HIDDEN_ITEMS_START + 0x1A)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_STARDUST_2   (FLAG_KANTO_HIDDEN_ITEMS_START + 0x1B)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_STAR_PIECE   (FLAG_KANTO_HIDDEN_ITEMS_START + 0x1C)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_ULTRA_BALL   (FLAG_KANTO_HIDDEN_ITEMS_START + 0x1D)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_ULTRA_BALL_2 (FLAG_KANTO_HIDDEN_ITEMS_START + 0x1E)
#define FLAG_HIDDEN_ITEM_POKEMON_MANSION_1F_MOON_STONE          (FLAG_KANTO_HIDDEN_ITEMS_START + 0x1F)
#define FLAG_HIDDEN_ITEM_POKEMON_MANSION_3F_RARE_CANDY          (FLAG_KANTO_HIDDEN_ITEMS_START + 0x20)
#define FLAG_HIDDEN_ITEM_POKEMON_MANSION_B1F_ELIXIR             (FLAG_KANTO_HIDDEN_ITEMS_START + 0x21)
#define FLAG_HIDDEN_ITEM_POKEMON_TOWER_5F_BIG_MUSHROOM          (FLAG_KANTO_HIDDEN_ITEMS_START + 0x22)
#define FLAG_HIDDEN_ITEM_POKEMON_TOWER_7F_SOOTHE_BELL           (FLAG_KANTO_HIDDEN_ITEMS_START + 0x23)
#define FLAG_HIDDEN_ITEM_POWER_PLANT_MAX_ELIXIR                 (FLAG_KANTO_HIDDEN_ITEMS_START + 0x24)
#define FLAG_HIDDEN_ITEM_POWER_PLANT_THUNDER_STONE              (FLAG_KANTO_HIDDEN_ITEMS_START + 0x25)
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B1F_PP_UP               (FLAG_KANTO_HIDDEN_ITEMS_START + 0x26)
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B3F_NUGGET              (FLAG_KANTO_HIDDEN_ITEMS_START + 0x27)
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B4F_NEST_BALL           (FLAG_KANTO_HIDDEN_ITEMS_START + 0x28)
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B4F_NET_BALL            (FLAG_KANTO_HIDDEN_ITEMS_START + 0x29)
#define FLAG_HIDDEN_ITEM_ROUTE21_NORTH_PEARL                    (FLAG_KANTO_HIDDEN_ITEMS_START + 0x2A)
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_CENTER_LEAF_STONE          (FLAG_KANTO_HIDDEN_ITEMS_START + 0x2B)
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_WEST_REVIVE                (FLAG_KANTO_HIDDEN_ITEMS_START + 0x2C)
#define FLAG_HIDDEN_ITEM_SAFFRON_CITY_COPYCATS_HOUSE_2F_NUGGET  (FLAG_KANTO_HIDDEN_ITEMS_START + 0x2D)
#define FLAG_HIDDEN_ITEM_SEAFOAM_ISLANDS_B3F_NUGGET             (FLAG_KANTO_HIDDEN_ITEMS_START + 0x2E)
#define FLAG_HIDDEN_ITEM_SEAFOAM_ISLANDS_B4F_WATER_STONE        (FLAG_KANTO_HIDDEN_ITEMS_START + 0x2F)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_SEVAULT_CANYON_CHERI_BERRY (FLAG_KANTO_HIDDEN_ITEMS_START + 0x30)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE_RAWST_BERRY (FLAG_KANTO_HIDDEN_ITEMS_START + 0x31)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE  (FLAG_KANTO_HIDDEN_ITEMS_START + 0x32)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE_2 (FLAG_KANTO_HIDDEN_ITEMS_START + 0x33)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE_3 (FLAG_KANTO_HIDDEN_ITEMS_START + 0x34)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE_4 (FLAG_KANTO_HIDDEN_ITEMS_START + 0x35)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TRAINER_TOWER_BIG_PEARL   (FLAG_KANTO_HIDDEN_ITEMS_START + 0x36)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TRAINER_TOWER_NANAB_BERRY (FLAG_KANTO_HIDDEN_ITEMS_START + 0x37)
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TRAINER_TOWER_PEARL       (FLAG_KANTO_HIDDEN_ITEMS_START + 0x38)
#define FLAG_HIDDEN_ITEM_SILPH_CO_10F_HP_UP                     (FLAG_KANTO_HIDDEN_ITEMS_START + 0x39)
#define FLAG_HIDDEN_ITEM_SILPH_CO_11F_REVIVE                    (FLAG_KANTO_HIDDEN_ITEMS_START + 0x3A)
#define FLAG_HIDDEN_ITEM_SILPH_CO_2F_ULTRA_BALL                 (FLAG_KANTO_HIDDEN_ITEMS_START + 0x3B)
#define FLAG_HIDDEN_ITEM_SILPH_CO_3F_PROTEIN                    (FLAG_KANTO_HIDDEN_ITEMS_START + 0x3C)
#define FLAG_HIDDEN_ITEM_SILPH_CO_4F_IRON                       (FLAG_KANTO_HIDDEN_ITEMS_START + 0x3D)
#define FLAG_HIDDEN_ITEM_SILPH_CO_5F_ELIXIR                     (FLAG_KANTO_HIDDEN_ITEMS_START + 0x3E)
#define FLAG_HIDDEN_ITEM_SILPH_CO_5F_PP_UP                      (FLAG_KANTO_HIDDEN_ITEMS_START + 0x3F)
#define FLAG_HIDDEN_ITEM_SILPH_CO_6F_CARBOS                     (FLAG_KANTO_HIDDEN_ITEMS_START + 0x40)
#define FLAG_HIDDEN_ITEM_SILPH_CO_7F_ZINC                       (FLAG_KANTO_HIDDEN_ITEMS_START + 0x41)
#define FLAG_HIDDEN_ITEM_SILPH_CO_8F_NUGGET                     (FLAG_KANTO_HIDDEN_ITEMS_START + 0x42)
#define FLAG_HIDDEN_ITEM_SILPH_CO_9F_CALCIUM                    (FLAG_KANTO_HIDDEN_ITEMS_START + 0x43)
#define FLAG_HIDDEN_ITEM_SILPH_CO_9F_MAX_POTION                 (FLAG_KANTO_HIDDEN_ITEMS_START + 0x44)
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_GREEN_PATH_ULTRA_BALL       (FLAG_KANTO_HIDDEN_ITEMS_START + 0x45)
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_LEPPA_BERRY                 (FLAG_KANTO_HIDDEN_ITEMS_START + 0x46)
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_OUTCAST_ISLAND_NET_BALL     (FLAG_KANTO_HIDDEN_ITEMS_START + 0x47)
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_OUTCAST_ISLAND_STAR_PIECE   (FLAG_KANTO_HIDDEN_ITEMS_START + 0x48)
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_WATER_PATH_ASPEAR_BERRY     (FLAG_KANTO_HIDDEN_ITEMS_START + 0x49)
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_WATER_PATH_ORAN_BERRY       (FLAG_KANTO_HIDDEN_ITEMS_START + 0x4A)
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_WATER_PATH_PINAP_BERRY      (FLAG_KANTO_HIDDEN_ITEMS_START + 0x4B)
#define FLAG_HIDDEN_ITEM_SSANNE_B1F_CORRIDOR_HYPER_POTION       (FLAG_KANTO_HIDDEN_ITEMS_START + 0x4C)
#define FLAG_HIDDEN_ITEM_SSANNE_EXTERIOR_LAVA_COOKIE            (FLAG_KANTO_HIDDEN_ITEMS_START + 0x4D)
#define FLAG_HIDDEN_ITEM_SSANNE_KITCHEN_CHERI_BERRY             (FLAG_KANTO_HIDDEN_ITEMS_START + 0x4E)
#define FLAG_HIDDEN_ITEM_SSANNE_KITCHEN_CHESTO_BERRY            (FLAG_KANTO_HIDDEN_ITEMS_START + 0x4F)
#define FLAG_HIDDEN_ITEM_SSANNE_KITCHEN_PECHA_BERRY             (FLAG_KANTO_HIDDEN_ITEMS_START + 0x50)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_ASPEAR_BERRY (FLAG_KANTO_HIDDEN_ITEMS_START + 0x51)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_BLUK_BERRY   (FLAG_KANTO_HIDDEN_ITEMS_START + 0x52)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_CHERI_BERRY  (FLAG_KANTO_HIDDEN_ITEMS_START + 0x53)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_CHESTO_BERRY (FLAG_KANTO_HIDDEN_ITEMS_START + 0x54)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_LUM_BERRY    (FLAG_KANTO_HIDDEN_ITEMS_START + 0x55)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_NANAB_BERRY  (FLAG_KANTO_HIDDEN_ITEMS_START + 0x56)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_ORAN_BERRY   (FLAG_KANTO_HIDDEN_ITEMS_START + 0x57)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PECHA_BERRY  (FLAG_KANTO_HIDDEN_ITEMS_START + 0x58)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PERSIM_BERRY (FLAG_KANTO_HIDDEN_ITEMS_START + 0x59)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PINAP_BERRY  (FLAG_KANTO_HIDDEN_ITEMS_START + 0x5A)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_RAWST_BERRY  (FLAG_KANTO_HIDDEN_ITEMS_START + 0x5B)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_RAZZ_BERRY   (FLAG_KANTO_HIDDEN_ITEMS_START + 0x5C)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_WEPEAR_BERRY (FLAG_KANTO_HIDDEN_ITEMS_START + 0x5D)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BOND_BRIDGE_MAX_REPEL     (FLAG_KANTO_HIDDEN_ITEMS_START + 0x5E)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BOND_BRIDGE_PEARL         (FLAG_KANTO_HIDDEN_ITEMS_START + 0x5F)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BOND_BRIDGE_STARDUST      (FLAG_KANTO_HIDDEN_ITEMS_START + 0x60)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_DUNSPARCE_TUNNEL_NUGGET   (FLAG_KANTO_HIDDEN_ITEMS_START + 0x61)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_PP_UP                     (FLAG_KANTO_HIDDEN_ITEMS_START + 0x62)
#define FLAG_HIDDEN_ITEM_TWO_ISLAND_CAPE_BRINK_PP_MAX           (FLAG_KANTO_HIDDEN_ITEMS_START + 0x63)
#define FLAG_HIDDEN_ITEM_TWO_ISLAND_CAPE_BRINK_RARE_CANDY       (FLAG_KANTO_HIDDEN_ITEMS_START + 0x64)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_ANTIDOTE (FLAG_KANTO_HIDDEN_ITEMS_START + 0x65)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_AWAKENING (FLAG_KANTO_HIDDEN_ITEMS_START + 0x66)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_BURN_HEAL (FLAG_KANTO_HIDDEN_ITEMS_START + 0x67)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_ETHER (FLAG_KANTO_HIDDEN_ITEMS_START + 0x68)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_ICE_HEAL (FLAG_KANTO_HIDDEN_ITEMS_START + 0x69)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_PARALYZE_HEAL (FLAG_KANTO_HIDDEN_ITEMS_START + 0x6A)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_POTION (FLAG_KANTO_HIDDEN_ITEMS_START + 0x6B)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_ANTIDOTE (FLAG_KANTO_HIDDEN_ITEMS_START + 0x6C)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_AWAKENING (FLAG_KANTO_HIDDEN_ITEMS_START + 0x6D)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_BURN_HEAL (FLAG_KANTO_HIDDEN_ITEMS_START + 0x6E)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_ETHER (FLAG_KANTO_HIDDEN_ITEMS_START + 0x6F)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_ICE_HEAL (FLAG_KANTO_HIDDEN_ITEMS_START + 0x70)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_PARALYZE_HEAL (FLAG_KANTO_HIDDEN_ITEMS_START + 0x71)
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_POTION (FLAG_KANTO_HIDDEN_ITEMS_START + 0x72)
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_1F_FULL_RESTORE           (FLAG_KANTO_HIDDEN_ITEMS_START + 0x73)
