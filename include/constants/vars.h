...
// Kanto/Johto multi-region state vars (formerly unused slots)
#define VAR_ROUTE27_STATE                                0x40F7
#define VAR_SUICUNE_ENCOUNTERS                           0x40F8
#define VAR_KANTO_ROCKET_STORY_STATE                     0x40F9
#define VAR_CERULEAN_CITY_STATE                          0x40FA
#define VAR_KANTO_SAFARI_ZONE_PROGRESS                   0x40FB
#define VAR_ROUTE27_BAOBA_CALL                           0x40FC
#define VAR_CURRENT_REGION                               0x40FD // enum Region value (see constants/regions.h); auto-set on map load
